...
git clone https://github.com/jakariajishan/hello-rails-react.git
...
Feel free to check the [issues page](https://github.com/jakariajishan/hello_rails_react/issues).
